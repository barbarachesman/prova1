    ...
    <div class="navbar navbar-inverse navbar-static-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $this->Html->url('/'); ?>">LabNet</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    <li><?php echo $this->Html->link('Exames', array('controller' => 'exames', 'action' => 'exames')); ?></li>
                    <li><?php echo $this->Html->link('Pacientes', array('controller' => 'pacientes', 'action' => 'index')); ?></li>
                    <li><?php echo $this->Html->link('Procedimentos', array('controller' => 'procedimentos', 'action' => 'index')); ?></li>
                    <li><?php echo $this->Html->link('Adm', array('controller' => 'pages', 'action' => 'login')); ?></li>

                </ul>
                <ul class="navbar-form form-inline navbar-right">
                    <?php echo $this->Html->link('Cadastrar',array('controller' => 'pacientes','action' => 'addp'));?> <br></br>
